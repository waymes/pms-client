...
import { FETCH_CURRENT_USER, UPDATE_CURRENT_USER } from '../actions/user';
import { FETCH_MY_PEOPLE, FETCH_PERSON, CREATE_NEW_PERSON, UPDATE_PERSON, DELETE_PERSON } from '../actions/people';
import { login, signup } from './auth';
import { fetchCurrentUser, updateCurrentUser } from './user';
...
export default function* rootSaga() {
  ...
  yield takeLatest(UPDATE_CURRENT_USER, updateCurrentUser);
